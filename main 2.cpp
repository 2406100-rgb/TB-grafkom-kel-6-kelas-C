// =============================================================
// RUANG TAMU 3D - Tugas Besar Grafik Komputer (FreeGLUT + OpenGL)
// Kelompok:
// - Meja         : Kaka
// - Kursi        : Adit
// - Rak + TV     : Isan
...
//
// Kontrol ringkas:
// - Kamera FPS  : W A S D + mouse (klik kiri untuk aktif), SPACE naik, C turun
// - Speed       : + / -
// - Lighting ON : L
// - Rak+TV      : T (maju +Z) / G (mundur -Z) / F (kiri -X) / H (kanan +X)
// - Kursi geser : Z / X
// - Meja        : N / M (maju mundur), U / I (rotasi)
// - Kursi scale : V (besar) / B (kecil)
// - Jendela     : O (buka) / P (tutup)
// - Pintu       : Q (buka) / E (tutup)
// - Reset meja  : R
// - Reset kursi : K
// - Exit        : ESC
// =============================================================
...
// ====== ROTASI MEJA (U / I)  [Meja: Kaka]
float tableRotY = 0.0f;

// ====== SCALE KURSI (V / B)  [Kursi: Adit]
float chairScale = 1.0f;

// ===================== POSISI LAMPU PLAFON (Lampu: Agil)
...
const float DOOR_CZ = 5.88f;

// ===================== DIMENSI JENDELA
const float WIN_CX = 0.0f;
const float WIN_CY = 3.3f;
const float WIN_CZ = -5.85f;
...
// =============================================================
// LIGHTING STATE (Lampu/Cahaya: Agil)
// =============================================================
void applyLightingState() {
    if (lightingEnabled) {
        ...
        glEnable(GL_NORMALIZE); // penting karena banyak glScalef
    } else {
        glDisable(GL_LIGHT0);
...
void updateLightingLogic() {
    ...
    // lightMode: 1=Ambient+Diffuse+Specular, 2=Ambient, 3=Diffuse, 4=Specular
    if (lightMode == 1) {
...
void drawFloorWood() {
    ...
    // garis kayu (tanpa lighting biar kontras)
    glDisable(GL_LIGHTING);
...
// =============================================================
// DINDING BELAKANG (ada lubang jendela + view luar)
// =============================================================
...
// =============================================================
// DINDING DEPAN (ada lubang pintu, TANPA view luar belakang pintu)
// =============================================================
...
// =============================================================
// OBJEK UTAMA: MEJA (Kaka)
// - bisa maju/mundur (N/M)
// - bisa rotasi (U/I)
// - reset meja (R)
// =============================================================
...
// =============================================================
// VAS + BUNGA (di atas meja, dekorasi)
// =============================================================
...
// =============================================================
// OBJEK UTAMA: KURSI (Adit)
// - bisa scale (V/B) dan reset (K)
// - bisa digeser kiri/kanan bareng-bareng (Z/X)
// =============================================================
...
// =============================================================
// OBJEK UTAMA: TV (Isan) - ditempatkan di atas rak
// =============================================================
void drawTVOnRack(float rx, float rz, float rotYDeg) {
    ...
    // layar (tanpa lighting biar warnanya stabil)
    glDisable(GL_LIGHTING);
...
// =============================================================
// Meja samping + tanaman kecil (dekorasi)
// =============================================================
...
// =============================================================
// OBJEK UTAMA: LAMPU FISIK (Agil) + efek beam
// =============================================================
...
void display() {
    ...
    // update parameter lampu tiap frame (Agil)
    updateLightingLogic();
...
// =============================================================
// MOUSE LOOK (klik kiri untuk aktif)
// =============================================================
